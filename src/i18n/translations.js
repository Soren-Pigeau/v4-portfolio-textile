...
export const translations = {
  fr: {
    nav: { projects: 'Projects', book: 'Book', about: 'About', print: 'Print' },
  ...
  en: {
    ...
    home: {
      bio: "Cyrielle Pigeau lives and works in Paris. Her practice combines photography and textile craftsmanship: weaving, upholstery and high-warp tapestry. She draws on learning and transmission to question the technical and symbolic dimensions of these practices in relation to her own cultural heritage.",
      toAbout: '→ about',
